...
public class CBFilterHelper : CBHelperBase<Cbfilter>
{
	public CBFilterHelper()
		: base(new Cbfilter(), "cbfilter.cab", new Version(20, 0, 8124, 0))
	{
	...
	public override bool Install(string appGuid)
	{
		...
		return base.Component.Install(base.DriverFilePath, appGuid, null, 1, 360000, 0);
	}
